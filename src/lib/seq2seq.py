...
# ==============================================================================
"""
Sequence to sequence DNC model, Training and prediction library.
"""
import math
...
class Seq2SeqModel(object):
    ...
    def init_encoder_variable(self):
        ...
        if (self.cell_type == 'dnc'):
            initial_state = self.dncInitial(self.dnc_batch_size)
    ...
    def build_decoder_cell(self):
        ...
        if (self.cell_type != 'dnc'):
            ...
            decoder_cell = attention_wrapper.AttentionWrapper(
                ...
                alignment_history=False,
                name='Attention_Wrapper')
            decoder_initial_state = decoder_cell.zero_state(batch_size=self.dnc_batch_size, dtype=self.dtype)
